...
impl Specialization {
    pub fn name(&self) -> &'static str {
        match self { Specialization::Assault => "Assault", Specialization::Medic => "Medic", Specialization::Engineer => "Engineer", Specialization::Recon => "Recon" }
    }
    pub fn damage_mod(&self) -> f32 {
        match self { Specialization::Assault => 1.15, _ => 1.0 }
    }
    pub fn speed_mod(&self) -> f32 {
        match self { Specialization::Assault => 1.1, _ => 1.0 }
    }
    pub fn accuracy_mod(&self) -> f32 {
        match self { Specialization::Recon => 1.2, _ => 1.0 }
    }
    pub fn ammo_mod(&self) -> f32 {
        match self { Specialization::Engineer => 1.2, _ => 1.0 }
    }
}
